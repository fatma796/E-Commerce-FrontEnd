    ...
    return (
        <div className="pt-40">
            <div className="max-w-md mx-auto px-6">
                <h2 className="text-4xl font-montserrat font-normal text-center mb-2">LOGIN</h2>
                <p className="text-center text-sm font-montserrat font-light text-black mb-12">
                    WELCOME BACK! YOUR SKIN'S HAPPY PLACE MISSED YOU.
                </p>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <button
                        type="submit"
                        className="w-28 px-9 py-2 font-light text-sm text-black border-[1.5px] border-[#353535] hover:bg-[#353535] hover:text-white rounded-full transition-all duration-300"
                    >
                        LOGIN
                    </button>
